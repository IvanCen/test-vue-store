...
export const LazyProductGallery = import('../../components/product-details/ProductGallery.vue' /* webpackChunkName: "components/product-details/ProductGallery" */).then(c => c.default || c)
export const LazyCommonProductsListPage = import('../../components/products-list/CommonProductsListPage.vue' /* webpackChunkName: "components/products-list/CommonProductsListPage" */).then(c => c.default || c)
